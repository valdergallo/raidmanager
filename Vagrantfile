...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo sed -i "s/local /# local /g" /etc/postgresql/$POSTGRE_VERSION/main/pg_hba.conf
    sudo sed -i "s/host /# host /g" /etc/postgresql/$POSTGRE_VERSION/main/pg_hba.conf
    # sudo sed -i "s/peer/md5/g" /etc/postgresql/$POSTGRE_VERSION/main/pg_hba.conf
    ...
    psql -U postgres -c "CREATE DATABASE \"raidmanager\";"
