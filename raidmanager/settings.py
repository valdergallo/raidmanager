"""
Django settings for raidmanager project.
...
SECRET_KEY = 'b#c8uhty#h(f_lc!z_k7r)q(pnja_xt-7ws*fjatd_szdvyd5y'
...
WSGI_APPLICATION = 'raidmanager.wsgi.application'
